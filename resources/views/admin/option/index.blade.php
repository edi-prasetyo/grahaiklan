                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="bing_meta" class="form-control"
                                        value="{{ $option->bing_meta }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Google Analytics</label>
                                    <textarea name="google_analytics" class="form-control">{{ $option->google_analytics }}</textarea>
                                </div>
                                <div class="col-md-6 mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="file" name="watermark" class="form-control mb-3">
                                    @if ($option->watermark == null)
                                    @else
                                        <img src="{{ asset('uploads/logo/' . $option->watermark) }}" class="img-fluid">
                                    @endif
                                </div>
